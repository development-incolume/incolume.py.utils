...
@deprecated(
    reason="This function was emancipated to new module 'incolume.py.changelog'.",
    version='2.11.0',
)
    ...
    **kwargs,
    ...
    for msg in text.strip().splitlines()[start:end]:
        ...
        try:
            ...
            if (with_prereleases and re.fullmatch(r1, key, re.IGNORECASE)) or (
                not with_prereleases and re.fullmatch(r2, key, re.IGNORECASE)
            ):
...
@deprecated(
    reason="This class was emancipated to new module 'incolume.py.changelog'.",
    version='2.11.0',
)
class Changelog:
    """Changelog class."""
