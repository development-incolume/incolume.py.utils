...
import pytest
from incolumepy.utils.files import realfilename, preserve_file
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            {"filebase": (test_dir/"britodfbr"/"diretorio"/"para"/"teste").as_posix(),
             "ext": ".dat",
             "separador": True,
             },
            (test_dir/"britodfbr"/"diretorio"/"para"/"teste").with_suffix('.dat').as_posix()
        ),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            test_dir/"file.md",
            {"separador": False, "digits": 4, "ext": "log", },
            "file0001.log",
            # marks=pytest.mark.skip(reason="Only skip")
        ),
        pytest.param(
