...
class UtilsTest(unittest.TestCase):
    ...
    def test_namespace3(self):
        self.assertTrue(namespace('incolumepy.package.subpackage') == ['incolumepy', 'incolumepy.package'])

    def test_namespace4(self):
        self.assertTrue(namespace('incolumepy.package.subpackage.module') == ['incolumepy','incolumepy.package','incolumepy.package.subpackage'])
